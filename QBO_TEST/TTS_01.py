...
print("-1-")
spk_02 = 'espeak -v mb-it3 -s 120 -p 35 -w /tmp/temp.wav "numero due" && aplay -r 8000 -D  convertQBO /tmp/temp.wav'
subprocess.call(spk_02, shell=True)
print("-2-")
spk_03 = 'espeak -v it -s 120 -p 35 -w /tmp/temp.wav "numero tre" && aplay -r 48000 -D  convertQBO /tmp/temp.wav'
