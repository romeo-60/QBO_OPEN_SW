...
# Commands definions :('NAME',value, number of set params, number of get params)
    ...
    def ReadResponse(self):
        global rx_data # serve per print
    ...
    def ProcessRxData(self, data):
        ...
        for x in range(3, nBytes - 2):
            ...
            print("rx_param", rx_param)
        return rx_param

    def GetHeadCmd(self, cmd, cmd_buffer):
        global rdParam #serve per print
        if not (cmd) in self.cmd_params:
            return 0
...
#        self.port.flush()
    ...
    def SetServo(self, Axis, Angle, Speed):
        ...
        print ("cmd_buffer SetServo: (" + str(Axis) + "," + str(Angle) + "," + str(Speed) + ")")
    ...
    def SetAngle(self, Axis, Angle):
        ...
        print ("cmd_buffer SetAngle: (" + str(axis) + "," + str(Angle) + ")")
    ...
    def SetMouth(self, matrix):
        ...
        print ("cmd_Buffer SetMouth", cmd_buffer)
