...
def Writer_Asks():
    ...
    writer.color('green')
    writer.goto (-150,-120)
    writer.write("do you want to try to find a solution? ")
    writer.goto (-150,-170)
    answer = input("do you want to try to find a solution? "+"tipe 'y' or 'n' ")
    if answer == "y" or answer == "Y":
        ...
        writer.goto (-160, -100)
        writer.write ("write the name of the cell where you want to eneter the number and confirm")
        writer.goto (-160, -110)
        writer.write ("the turtle will move to the cell!")
        writer.goto (-160, -120)
        writer.write ("then write a valid number (from 1 to 9) ")
        writer.goto (-160, -130)
        writer.write ("for the cell where the is the turtle and confirm... look what happens...")
        writer.goto (-160, -140)
        writer.write ("repeat these entries for all cells")
        writer.goto (-160, -150)
        writer.write ("if you want to finish, write 'E' ")
        writer.color ("blue")
        writer.goto (-160, -160)
        ...
        writer.goto(-150,-130)
        writer.write("your answer is  NO!, So you want me to try it?")
...
def Final_considerations():
    if level == 1:
        ...
        #if (len(Boxes)==0 or counter==limit) and level>1: old version
